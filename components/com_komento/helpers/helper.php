...
class Komento
{
	...
	public static function import( $type, $filename )
	{
		if ($type == 'helper')
		{
			require_once( KOMENTO_HELPERS . DIRECTORY_SEPARATOR . $filename . '.php' );
		}
		if ($type == 'class')
		{
			require_once( KOMENTO_CLASSES . DIRECTORY_SEPARATOR . $filename . '.php' );
		}
	...
	public static function loadApplication( $component )
	{
		...
		if( empty($instances[$component]) )
		{
			...
			$file = JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . $component . DIRECTORY_SEPARATOR . 'komento_plugin.php';
			if( !JFile::exists($file) )
			{
				// Load from Komento's plugin folder
				$file = KOMENTO_ROOT . DIRECTORY_SEPARATOR . 'komento_plugins' . DIRECTORY_SEPARATOR . $component . '.php';
				if ( !JFile::exists($file) )
				{
					return false;
				}
	...
	/* List of triggers:
		...
		onBeforeKomentoBar
		onAfterKomentoBar
		onBeforeKomentoTabList
		onAfterKomentoTabList
		onBeforeKomentoTabNavigation
		onAfterKomentoTabNavigation
		onBeforeKomentoTabContent
		onAfterKomentoTabContent
		onBeforeKomentoForm
		onAfterKomentoForm
		onBeforeKomentoFormFields
		onAfterKomentoFormFields
		onBeforeKomentoFormAuthor
		onAfterKomentoFormAuthor
		onBeforeKomentoFormContent
		onAfterKomentoFormContent
		onBeforeKomentoFormUpload
		onAfterKomentoFormUpload
		onBeforeKomentoFormCaptcha
		onAfterKomentoFormCaptcha
		onBeforeKomentoFormSubmit
		onAfterKomentoFormSubmit
		onBeforeKomentoItem( $params['system', 'options', 'comment'] )
		onAfterKomentoItem( $params['system', 'options', 'comment'] )
		onBeforeKomentoItemAvatar( $params['system', 'options', 'comment'] )
		onAfterKomentoItemAvatar( $params['system', 'options', 'comment'] )
		onBeforeKomentoItemHead( $params['system', 'options', 'comment'] )
		onAfterKomentoItemHead( $params['system', 'options', 'comment'] )
		onBeforeKomentoItemContent( $params['system', 'options', 'comment'] )
		onAfterKomentoItemContent( $params['system', 'options', 'comment'] )
		onBeforeKomentoItemAttachment( $params['system', 'options', 'comment'] )
		onAfterKomentoItemAttachment( $params['system', 'options', 'comment'] )
		onBeforeKomentoItemInfo( $params['system', 'options', 'comment'] )
		onAfterKomentoItemInfo( $params['system', 'options', 'comment'] )
		onBeforeKomentoItemMeta( $params['system', 'options', 'comment'] )
		onAfterKomentoItemMeta( $params['system', 'options', 'comment'] )
		onBeforeKomentoItemUserAction( $params['system', 'options', 'comment'] )
		onAfterKomentoItemUserAction( $params['system', 'options', 'comment'] )
		onBeforeKomentoList( $params['system', 'options', 'comments'] )
		onAfterKomentoList( $params['system', 'options', 'comments'] )
		onBeforeKomentoProfile
		onAfterKomentoProfile
		onBeforeKomentoProfileSidebar
		onAfterKomentoProfileSidebar
		onBeforeKomentoProfileTabsNavigation
		onAfterKomentoProfileTabsNavigation
		onBeforeKomentoProfileTabsContent
		onAfterKomentoProfileTabsContent
		onBeforeKomentoProcessNewComment( $params['comment'] )
		onAfterKomentoProcessNewComment( $params['comment', 'html'] )
		onBeforeKomentoSaveNewComment( $params['comment'] )
		onAfterKomentoSaveNewComment( $params['comment] )
	*/
	public static function trigger( $event, $params = array() )
	{
		...
		$results = $application->triggerEvent( $event, array( $params ) );
