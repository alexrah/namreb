...
<div id="section-kmt">
	...
	<?php echo Komento::trigger( 'onBeforeKomentoProfile' ); ?>
	...
	<?php echo Komento::trigger( 'onBeforeKomentoProfileSidebar' ); ?>

	<?php echo $this->fetch( 'profile/sidebar.php' ); ?>

	<?php echo Komento::trigger( 'onAfterKomentoProfileSidebar' ); ?>

	<!-- tabs -->
	<div id="kmt-profile-tabs">
		<ul class="kmt-profile-tab reset-ul float-li clearfix">
			<?php echo Komento::trigger( 'onBeforeKomentoProfileTabsNavigation' ); ?>
			...
			<?php echo Komento::trigger( 'onAfterKomentoProfileTabsNavigation' ); ?>
		</ul>

		<?php echo Komento::trigger( 'onBeforeKomentoProfileTabsContent' ); ?>

		<div id="kmt-activities" class="tabs"></div>
		<div id="kmt-popular" class="tabs"></div>
		<div id="kmt-sticked" class="tabs"></div>

		<?php echo Komento::trigger( 'onAfterKomentoProfileTabsContent' ); ?>
	</div>

	<?php echo Komento::trigger( 'onAfterKomentoProfile' ); ?>
</div>
