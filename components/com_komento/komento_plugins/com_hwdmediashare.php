...
require_once( JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_hwdmediashare' . DIRECTORY_SEPARATOR . 'helpers' . DIRECTORY_SEPARATOR .'route.php' );
require_once( JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_hwdmediashare' . DIRECTORY_SEPARATOR . 'libraries' . DIRECTORY_SEPARATOR .'factory.php' );

class KomentoComHwdmediashare extends KomentoExtension
{
	public $component = 'com_hwdmediashare';
	public $_item;
	public $_map = array(
		'id'			=> 'id',
		'title'			=> 'title',
	...
	{
		return JRequest::getCmd('view') == 'mediaitem';
	}
