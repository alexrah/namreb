...
class KomentoViewKomento extends KomentoView
{
	...
	function addComment()
	{
		...
		Komento::trigger( 'onBeforeKomentoProcessNewComment', array( 'comment' => $commentObj ) );
		...
		// Trigger onBeforeKomentoSaveComment (no echo needed as this should be just data manipulation)
		Komento::trigger( 'onBeforeKomentoSaveNewComment', array( 'comment' => &$commentObj ) );
		...
		Komento::trigger( 'onAfterKomentoSaveNewComment', array( 'comment' => &$commentObj ) );
		...
		Komento::trigger( 'onAfterKomentoProcessNewComment', array( 'comment' => &$commentObj, 'html' => &$html ) );
