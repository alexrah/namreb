...
<div class="center span7"><div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
...
<div class="itemImageBlock_k2">

<div class="xtc-full-img img-fulltext-right imgframe">		  
<!-- <span class="itemImage"> -->
		  	<a class="modalx" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
...
<div class="btn-group pull-right"> <a class="btn dropdown-toggle" data-toggle="dropdown" href="#"> <i class="icon-cog"></i> <span class="caret"></span> </a>
    <ul class="dropdown-menu">
                  <li class="print-icon"> <a href="/berman/index.php/azienda?tmpl=component&amp;print=1&amp;page=" title="Stampa" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow"><i class="icon-print"></i> Stampa</a> </li>
                  <li class="email-icon"> <a href="/berman/index.php/component/mailto/?tmpl=component&amp;template=motif&amp;link=9152230ee3afcc380015cd155fd165d2fbe963a7" title="Email" onclick="window.open(this.href,'win2','width=400,height=350,menubar=yes,resizable=yes'); return false;"><i class="icon-envelope"></i> Email</a> </li>
                      </ul>
  </div>
...
<div class="item-page wtitle">	 
  <div class="article_text">
    <div class="itemFullText">
      ...
      <div class="underlinered">
<h3 class="moduletitle"><span class="first_word"><?php echo JText::_('K2_ADDITIONAL_INFO'); ?></span></h3>
</div>	  	<ul>
...
<?php
  $document = JFactory::getDocument(); 
      ...
      $params = array('style' => 'xtc'); 
      $position = 'sidebarright';
      foreach (JModuleHelper::getModules($position) as $module) 
      { echo $renderer->render($module, $params);}
?>

<jdoc:include type="module" name="whosonline" title="Who's Online" />
