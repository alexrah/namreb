...
<?php echo Komento::trigger( 'onBeforeKomentoList', array( 'system' => &$system, 'options' => &$options, 'comments' => &$comments ) ); ?>
...
<?php echo Komento::trigger( 'onAfterKomentoList', array( 'system' => &$system, 'options' => &$options, 'comments' => &$comments ) ); ?>
