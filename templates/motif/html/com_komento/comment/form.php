...
<?php echo Komento::trigger( 'onBeforeKomentoForm', array( 'system' => &$system, 'options' => &$options ) ); ?>
	...
	<div id="kmt-form" class="commentForm kmt-form clearfix">
		...
		<div class="formArea kmt-form-area<?php if( $system->config->get( 'form_toggle_button' ) ) echo ' hidden'; ?>">
			...
			<form>
				...
				<?php echo Komento::trigger( 'onBeforeKomentoFormFields', array( 'system' => &$system, 'options' => &$options ) ); ?>
				...
				<?php } ?>
				<?php echo Komento::trigger( 'onAfterKomentoFormFields', array( 'system' => &$system, 'options' => &$options ) ); ?>

				<?php echo Komento::trigger( 'onBeforeKomentoFormAuthor', array( 'system' => &$system, 'options' => &$options ) ); ?>
				...
				<?php echo Komento::trigger( 'onAfterKomentoFormAuthor', array( 'system' => &$system, 'options' => &$options ) ); ?>

				<?php echo Komento::trigger( 'onBeforeKomentoFormContent', array( 'system' => &$system, 'options' => &$options ) ); ?>
				...
				<?php echo Komento::trigger( 'onAfterKomentoFormContent', array( 'system' => &$system, 'options' => &$options ) ); ?>

				<?php echo Komento::trigger( 'onBeforeKomentoFormUpload', array( 'system' => &$system, 'options' => &$options ) ); ?>
				...
				<?php echo Komento::trigger( 'onAfterKomentoFormUpload', array( 'system' => &$system, 'options' => &$options ) ); ?>

				<?php echo Komento::trigger( 'onBeforeKomentoFormCaptcha', array( 'system' => &$system, 'options' => &$options ) ); ?>
				<?php
					// Captcha div.kmt-form-captcha
					echo $this->fetch( 'comment/form/captcha.php' );
				?>
				<?php echo Komento::trigger( 'onAfterKomentoFormCaptcha', array( 'system' => &$system, 'options' => &$options ) ); ?>

				<?php echo Komento::trigger( 'onBeforeKomentoFormSubmit', array( 'system' => &$system, 'options' => &$options ) ); ?>
				...
				<?php echo Komento::trigger( 'onAfterKomentoFormSubmit', array( 'system' => &$system, 'options' => &$options ) ); ?>
...
<?php } ?>
<?php echo Komento::trigger( 'onAfterKomentoForm', array( 'system' => &$system, 'options' => &$options ) ); ?>
