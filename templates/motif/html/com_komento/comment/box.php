...
<?php echo Komento::trigger( 'onBeforeKomento', array( 'system' => &$system, 'options' => &$options, 'comments' => &$comments ) ); ?>
...
<?php echo Komento::trigger( 'onAfterKomento', array( 'system' => &$system, 'options' => &$options, 'comments' => &$comments ) ); ?>
