...
<?php echo Komento::trigger( 'onBeforeKomentoTabList' ); ?>

<div id="kmt-fame" class="fameList">
	<ul class="kmt-fame-tabs reset-ul col<?php echo $tabs; ?>">

	<?php echo Komento::trigger( 'onBeforeKomentoTabNavigation' ); ?>
	...
	<?php echo Komento::trigger( 'onAfterKomentoTabNavigation' ); ?>

	</ul>

	<?php echo Komento::trigger( 'onBeforeKomentoTabContent' ); ?>
	...
	<?php echo Komento::trigger( 'onAfterKomentoTabContent' ); ?>

</div>

<?php echo Komento::trigger( 'onAfterKomentoTabList' ); ?>
