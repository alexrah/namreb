			...
			<fieldset class="adminform" id="dkim_config" style="display:none">
				...
				<table class="admintable" cellspacing="1" >
					<tr>
						...
						<td>
							<input class="inputbox" type="text" name="config[dkim_domain]" style="width:160px" value="<?php echo $this->escape($this->config->get('dkim_domain','')); ?>" /> *
						</td>
					</tr>
					<tr>
						<td width="185" class="key">
						...
						<td>
							<input class="inputbox" type="text" name="config[dkim_selector]" style="width:160px" value="<?php echo $this->escape($this->config->get('dkim_selector','')); ?>" /> *
						</td>
					</tr>
					<tr>
						<td width="185" class="key">
						...
						<td>
							<textarea cols="65" rows="8" style="width:460px;font-size:10px;" name="config[dkim_private]"><?php echo $this->config->get('dkim_private',''); ?></textarea> *
						</td>
					</tr>
					<tr>
						<td width="185" class="key">
						...
						<td>
							<input class="inputbox" type="text" name="config[dkim_passphrase]" style="width:160px" value="<?php echo $this->escape($this->config->get('dkim_passphrase','')); ?>" />
						</td>
					</tr>
					<tr>
						<td width="185" class="key">
						...
						<td>
							<input class="inputbox" type="text" name="config[dkim_identity]" style="width:160px" value="<?php echo $this->escape($this->config->get('dkim_identity','')); ?>" />
						</td>
					</tr>
					<tr>
						<td width="185" class="key">
						...
						<td>
							<textarea cols="65" rows="5" style="width:460px;font-size:10px;" name="config[dkim_public]"><?php echo $this->config->get('dkim_public',''); ?></textarea>
						</td>
					</tr>
				</table>
