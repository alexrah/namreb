...
class acypluginsHelper{
	...
	function getFormattedResult($elements,$parameter){
		...
		$beforeBlock = array('table' => '<tr class="elementstable_tr numrow{rownum}">');
		$beforeOne = array('table' => '<td valign="top" width="{equalwidth}" class="elementstable_td numcol{numcol}" >');
