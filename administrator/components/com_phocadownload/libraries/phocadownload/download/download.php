...
{
	function download($fileData, $downloadId, $currentLink, $type = 0) {
	...
	function getDownloadData($id, $return, $type = 0) {
		...
		if ($type == 1) {
			$this->_directlink = 0;// Unique Download Link cannot work with direct link
		}
	...
	protected function hitToken($id) {
		$db = JFactory::getDBO();
