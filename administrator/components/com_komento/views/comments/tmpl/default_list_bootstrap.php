...
if( $this->comments ) {
	...
	{
		// $this->row			= $this->comments[$this->i];

		// failsafe check
		// todo: need a better failsafe check where comments still show but component and cid shows error
		if( $this->row->component == '' || $this->row->cid == '' )
		{
			// $model = Komento::getModel( 'comments' );
			// $model->remove($this->row->id);
			continue;
		}
