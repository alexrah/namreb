...
$components	= Komento::getModel( 'migrators', true )->getMigrator( 'cjcomment' )->getUniqueComponents();
$selection = array();
...
<div id="migrator-cjcomment" migrator-type="cjcomment" migration-type="component" class="noshow migratorTable row-fluid">
	<div class="span12">
		<div class="span6">
...
<?php } else { ?>
<div id="migrator-cjcomment" class="noshow adminlist span12">
	<div class="span12">
		<div class="span6"><?php echo JText::_( 'COM_KOMENTO_CJCOMMENT_NOT_INSTALLED' ); ?></div>
		<div class="span6"></div>
	</div>
</div>
<?php }
