...
<div id="migrator-zoo" migrator-type="zoo" migration-type="article" class="noshow migratorTable row-fluid">
	<div class="span12">
		<div class="span6">
...
<?php } else { ?>
<div id="migrator-zoo" class="noshow adminlist row-fluid">
	<div class="span12">
		<div class="span6"><?php echo JText::_( 'COM_KOMENTO_ZOO_NOT_INSTALLED' ); ?></div>
		<div class="span6"></div>
	</div>
</div>
<?php } ?>
