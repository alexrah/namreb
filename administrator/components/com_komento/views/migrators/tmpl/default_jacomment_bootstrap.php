...
$components	= Komento::getModel( 'migrators', true )->getMigrator( 'jacomment' )->getUniqueComponents();
$selection = array();
...
<div id="migrator-jacomment" migrator-type="jacomment" migration-type="component" class="noshow migratorTable row-fluid">
	<div class="span12">
		<div class="span6">
...
<?php } else { ?>
<div id="migrator-jacomment" class="noshow adminlist row-fluid">
	<div class="span12">
		<div class="span6"><?php echo JText::_( 'COM_KOMENTO_JACOMMENT_NOT_INSTALLED' ); ?></div>
		<div class="span6"></div>
	</div>
</div>
<?php } ?>
