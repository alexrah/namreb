...
<div id="migrator-k2" migrator-type="k2" migration-type="article" class="noshow migratorTable row-fluid">
	<div class="span12">
		<div class="span6">
...
<?php } else { ?>
<div id="migrator-k2" class="noshow adminlist row-fluid">
	<div class="span12">
		<div class="span6"><?php echo JText::_( 'COM_KOMENTO_K2_NOT_INSTALLED' ); ?></div>
		<div class="span6"></div>
	</div>
</div>
<?php } ?>
